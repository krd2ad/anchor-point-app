...
export const SEED_ATTACHMENTS: Attachment[] = [
  ...
  {
    id: 'att-1d', loanId: 'loan-1',
    name: 'Application – Bill Twyford',
    kind: 'Other', status: 'requested',
    category: 'Loan Intake', fileType: 'pdf',
    sizeBytes: undefined, uploadedAt: undefined, uploadedById: undefined,
  },
  {
    id: 'att-1e', loanId: 'loan-1',
    name: 'Initial Intake Email',
    kind: 'Other', status: 'requested',
    category: 'Loan Intake', fileType: 'docx',
    sizeBytes: undefined, uploadedAt: undefined, uploadedById: undefined,
  },
  {
    ...
    category: 'Processing / Underwriting', fileType: 'jpg',
  ...
  },
  {
    ...
    kind: 'Other', status: 'requested',
    category: 'Processing / Underwriting', fileType: 'pdf',
    sizeBytes: undefined, uploadedAt: undefined, uploadedById: undefined,
  },
  ...
  },
  {
    ...
    name: 'Secured Note',
    kind: 'Other', status: 'requested',
    category: 'Loan Documents', fileType: 'pdf',
    sizeBytes: undefined, uploadedAt: undefined, uploadedById: undefined,
  },
  {
  ...
  {
    id: 'att-6q', loanId: 'loan-6',
    name: 'Demand Letter – Wabash Crossing',
    kind: 'Other', status: 'verified',
    category: 'Default / Foreclosure', fileType: 'pdf',
    sizeBytes: 145000, uploadedAt: '2024-07-10T09:00:00.000Z', uploadedById: 'user-1',
  },
  {
    id: 'att-6r', loanId: 'loan-6',
    name: 'Notice of Foreclosure',
    kind: 'Other', status: 'verified',
    category: 'Default / Foreclosure', fileType: 'pdf',
    sizeBytes: 320000, uploadedAt: '2024-08-15T10:00:00.000Z', uploadedById: 'user-1',
  },
  ...
  {
    id: 'att-7s', loanId: 'loan-7',
    name: 'Demand Letter – Ski Resort Chewelah',
    kind: 'Other', status: 'verified',
    category: 'Default / Foreclosure', fileType: 'pdf',
    sizeBytes: 138000, uploadedAt: '2024-08-01T09:00:00.000Z', uploadedById: 'user-1',
  },
  {
    id: 'att-7t', loanId: 'loan-7',
    name: 'Notice of Foreclosure',
    kind: 'Other', status: 'verified',
    category: 'Default / Foreclosure', fileType: 'pdf',
    sizeBytes: 295000, uploadedAt: '2024-09-12T10:00:00.000Z', uploadedById: 'user-1',
  },
  ...
  },
  {
    ...
    name: 'Payoff Letter from NSC – Riverstone Capital LLC',
    kind: 'Other', status: 'verified',
    category: 'Complete / Paid Off', fileType: 'pdf',
  ...
  {
    id: 'att-8r', loanId: 'loan-8',
    name: 'Reconveyance / Release of Lien',
    kind: 'Deed', status: 'verified',
    category: 'Complete / Paid Off', fileType: 'pdf',
    sizeBytes: 215000, uploadedAt: '2025-03-15T11:00:00.000Z', uploadedById: 'user-2',
  },
];
